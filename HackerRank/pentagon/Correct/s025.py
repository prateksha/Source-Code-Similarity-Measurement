...
class Shape():
	...
	def get_details(self):
		return self.name + '(' + str(area) + ' = ' + str(self.area) + ', ' + str(circumference) + ' = ' + str(self.circumference) + ')'
...
class EquilateralTriangle(RegularPolygon):
	def __init__(self, side):
		RegularPolygon.__init__(self, 3, side, name = "EquilateralTriangle")
	def area(self):
		return RegularPolygon.area()
	def circumference(self):
		return RegularPolygon.circumference()
...
class Pentagon(RegularPolygon):
	def __init__(self, side):
		RegularPolygon.__init__(self, 5, side, name = "Polygon")
	def area(self):
		return RegularPolygon.area()
	def circumference(self):
		return RegularPolygon.circumference()
