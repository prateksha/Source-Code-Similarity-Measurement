...
class Square(RegularPolygon):
  ...
  def area(self):
    return self.RegularPolygon.area
  def circumference(self):
    return self.RegularPolygon.circumference

# your code for class EquilateralTriangle -- Q.4(c)
class EquilateralTriangle(RegularPolygon):
  def __init__(self,s,name="Equilateral Traingle"):
...
class Pentagon(EquilateralTriangle,Square):
  def __init__(self,s,name="Pentagon"):
    EquilateralTriangle.__init__(self,s,name)
    Square.__init__(self,s,name)
  def area(self):
    return self.Square.area + self.EquilateralTriangle.area
  def circumference(self):
