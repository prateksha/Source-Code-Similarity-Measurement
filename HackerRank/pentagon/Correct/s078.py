...
class Pentagon(EquilateralTriangle,Square,Shape):
    def __init__(self,t,name="Pentagon"):
        EquilateralTriangle.__init__(self,t,name)
        Square.__init__(self,t,name)

    def area(self):
        return EquilateralTriangle.area(self)+Square.area(self)
    def circumference(self):
        return EquilateralTriangle.circumference(self)+Square.circumference(self)
    def __str__(self):
        return self.name + "("  + \
        "area = " + str(self.area()) + \
        ", circumference = " + str(self.circumference()) + ")"
