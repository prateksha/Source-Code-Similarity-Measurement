...
class Shape:
    ...
    def get_details(self):
        return str(self)+" = "+self.name+"(area ="+self.area()+", circumference = "+self.circumference()+")"
...
class Square(RegularPolygon,Shape):
...
class Pentagon(Triangle,Square,RegularPolygon):
    def __init__(self,triangle,square,name="Pentagon"):
