...
class Square(RegularPolygon):
 def __init__(self,l):
  self.l=l
  RegularPolygon.__init__(self,4,self.l,"Square")
...
class EquilateralTriangle(RegularPolygon):
 def __init__(self,l):
  self.l=l
  RegularPolygon.__init__(self,3,self.l,"EquilateralTriangle")
...
class Pentagon(RegularPolygon):
 def __init__(self,l):
  ...
  RegularPolygon.__init__(self,5,l,"Pentagon")
 def area(self):
  return self.triangle.area()+self.square.area()
 def circumfernce(self):
  return 5*self.triangle.l
