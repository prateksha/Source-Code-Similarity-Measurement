...
class Shape:
  def __init__(self,name):
    ...
    print(name,"(area = ",self.area(),", circumference = ",self.circumference())
...
class Pentagon(RegularPolygon):
  def __init__(self,s,name= "Pentagon"):
    self.square = Square(s,name)
    self.triangle = Triangle(s,s*math.sqrt(3)/2,name)
    self.name = name
