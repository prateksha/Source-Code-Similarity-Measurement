...
class Shape:
    ...
    def get_details(self):
        return str(str(self.name) + "(area = "+str((self.name).area)+", circumference = "+str((self.name).circumference)+")"
...
class EquilateralTriangle(RegularPolygon):
    def __init__(self,side,name="Equilateral Triangle"):
        RegularPolygon.__init__(self,3,side,name)
    RegularPolygon.area
# your code for class Pentagon -- Q.4(d) and Q.4(e)
class Pentagon(RegularPolygon):
    def __init__(self,(triangle=3,square=4),name="Pentagon"):
       # self.square = 4
       # self.triangle = 3
