...
class Square(RegularPolygon):
     def __init__(self,length,name="Square"):
         RegularPolyon.__init__(self,4,lenght,name)
         self.length=length
     def area(self):
         return RegularPolgon.area
# your code for class EquilateralTriangle -- Q.4(c)
class EquilateralTriangle(RegularPolygon):
    def __init(self,no_of_sides,length,name="EquilateralTriangle"):
        RegularPolygon.__init__(self,3,5,name)
        self.length=length
    def area(self):
