...
class Square(RegularPolygon):
    def __init__(self,length):
        self.length=length
        RegularPolygon.__init__(self,4,length,name="Square")
# your code for class EquilateralTriangle -- Q.4(c)
class EquilateralTriangle(RegularPolygon):
    def __init__(self,length):
        self.length=length
        RegularPolygon.__init__(self,3,length,name="Equilateral Triangle")
# your code for class Pentagon -- Q.4(d) and Q.4(e)
class Pentagon(RegularPolygon):
    def __init__(self,length):
        self.length=length
        RegularPolygon.__init__(self,5,length,name="Pentagon")
