...
class Square(RegularPolygon):
    def __init__(self,s):
        RegularPolygon.__init__(self,4,s,"Square")
...
class Pentagon(RegularPolygon):
    def __init__(self,s):
        RegularPolygon.__init__(self,5,s,"Pentagon")
        self.triangle=EquilateralTriangle(s)
        self.square=Square(s)
    def area(self):
        return self.triangle.area()+self.square.area()
    def circumference(self):
        return self.triangle.circumference()+self.square.circumference()-2*self.square.length
