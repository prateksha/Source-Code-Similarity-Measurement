...
class EquilateralTriangle(RegularPolygon):
    def __init__(self,b):
        RegularPolygon.__init__(self, 3, b,name="EquilateralTriangle")
# your code for class Pentagon -- Q.4(d) and Q.4(e)
class Pentagon(RegularPolygon):
    def __init__(self,s,name="Pentagon"):
        RegularPolygon.__init__(self,5,s,name)
        self.triangle=RegularPolygon.__init__(self,3,s,name)
        self.square=RegularPolygon.__init__(self,4,s,name)
